...
from cryptofeed.pairs import binance_pairs, coinbase_pairs, poloniex_pairs, kraken_rest_pairs
...
if __name__ == '__main__':
    ...
    logging.basicConfig(
        ...
        filemode='w',
        level=logging.INFO,
        format='%(asctime)s %(levelname)s [%(process)d] %(module)s.%(funcName)s +%(lineno)s: %(message)s')
